...
It should be noted that this kind of quotients in set-theory are ill-behaved with respect to families. Indeed assume you have a family of sets $(X_a)_{a\in A}$ indexed by a set $A$, and and a relation relation $\_\sim\_$ on $A$.% (this means that $x\sim y$ is a set for all $x,y:A$). 
